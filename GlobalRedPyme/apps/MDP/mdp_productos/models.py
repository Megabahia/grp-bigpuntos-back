...
class HistorialAvisos(models.Model):
    ...
    def save(self, *args, **kwargs):
        """
        ESte tema sirve para guardar actualizar el stock de los productos
        @type kwargs: El campo kwargs recibe los argumentos
        @type args: El campo args recibe los campos se de van a guardar
        @rtype: DEvuevle el registro guardado
        """
