...
# Mundo: bigpuntos
# Portales: Corp
# Esta clase sirve para relacionarse con la tabla negocios de la base datos mdm
...
# Mundo: bigpuntos
# Portales: Corp
# Esta clase sirve para relacionarse con la tabla direcciones de la base datos mdm
...
# Mundo: bigpuntos
# Portales: Corp
# Esta clase sirve para relacionarse con la tabla personal negocios de la base datos mdm
class PersonalNegocios(models.Model):
    ...
    correoEmpresa = models.EmailField(max_length=150, null=True, blank=True)
