...
from .serializers import FacturasSerializer, FacturasListarSerializer, FacturaSerializer, FacturasListarTablaSerializer
from ...MDP.mdp_productos.models import Productos
from ...MDM.mdm_clientes.models import Clientes
from ...MDM.mdm_negocios.models import Negocios
...
def factura_list(request):
    """
    Este metodo sirve para listar las facturas de la tabla de la base datos mdm
    @type request: El campo request recibe negocio, cliente, empresa_id, page, page_size
    @rtype: DEvuelve una lista de las facturas
    """
...
def factura_list_negocio(request):
    """
    Este metodo sirve para listar las facturas de la tabla facturas de la base datos mdm
    @type request: El campo request recibe page, page_size, inicio, fin, empresa_id
    @rtype: Devuelve una lista de las facturas, caso contrario devuelve el error generado
    """
    timezone_now = timezone.localtime(timezone.now())
    logModel = {
        'endPoint': logApi + 'list/',
...
def factura_list_todos_rango_fecha_cliente_grafica(request):
    """
    Este metodo sirve para listar las facturas de la tabla facturas de la base datos mdm
    @type request: El campo request recibe page, page_size, inicio, fin
    @rtype: Devuelve una lista de las facturas, caso contrario devuelve el error generado
    """
    timezone_now = timezone.localtime(timezone.now())
    logModel = {
...
def factura_findOne(request, pk):
    """
    Este metodo sirve para obtener la factura de la tabla factura de la base datos mdm
    @type pk: El campo pk recibe el id de la factura
    @type request: El campo request no recibe nada
    @rtype: Devuelve el registro obtenido, caso contrario devuelve lel error generado
    """
    timezone_now = timezone.localtime(timezone.now())
    logModel = {
...
def factura_list_latest(request):
    """
    Este metodo sirve para listar la ultima factura de la tabla facturas de la base datos mdm
    @type request: El campo request recibe negocio, cliente
...
def factura_create(request):
    ...
    @type request: El campo request recibe los campos de la tabla factura
...
def factura_update(request, pk):
    """
    Este metodo sirve para actualizar la factura de la tabla factura de la base datos mdm
    @type pk: El campo pk recibe el id de la factura
    @type request: El campo request recibe los campos de la tabla factura
...
def factura_delete(request, pk):
    """
    Este metodo sirve para eliminar la factura de la tabla factura de la base datos mdm
    @type pk: El campo pk recibe el id de la factura
    @type request: El campo request no recibe nada
    @rtype: Devuelve la factura eliminada, caso contrario devuelve el error generado
    """
