...
# Mundo: Bigpuntos
# Portales: CORP
# ESta clase se relaciona con la tabla clientes de la base de datos mdm
...
# Mundo: Bigpuntos
# Portales: CORP
# ESta clase se relaciona con la tabla datos fisicos de la base de datos mdm
...
# Mundo: Bigpuntos
# Portales: CORP
# ESta clase se relaciona con la tabla datos virtuales de la base de datos mdm
...
# Mundo: Bigpuntos
# Portales: CORP
# ESta clase se relaciona con la tabla parientes de la base de datos mdm
