...
class MDPRouter:
    ...
    auth and contenttypes applications.
    """
    route_app_labels = {'mdp_categorias','mdp_productos','mdp_fichaTecnicaProductos','mdp_subCategorias'}
...
class MDORouter:
    ...
    auth and contenttypes applications.
    """
    route_app_labels = {'mdo_generarOferta','mdo_prediccionCrosseling','mdo_prediccionProductosNuevos','mdo_prediccionRefil'}
