...
from .views import (
    empresas_create, empresas_list, empresas_listOne, empresas_update, empresas_delete,
    empresas_list_filtro, empresas_list_comercial, empresas_list_all, empresas_list_ifis,
    empresas_list_convenio, empresas_create_convenio, empresas_listOne_filtros, empresas_list_logos,
    empresas_list_array, empresas_uploadEmpleados, empresas_listEmpleados, empresas_listOne_empleado,
    empresas_listOne_empresa_empleado, empresas_update_empleado, empresas_delete_empleado,
)
...
urlpatterns = [
    ...
    path('list/all', empresas_list_all, name="empresas_list_all"),
