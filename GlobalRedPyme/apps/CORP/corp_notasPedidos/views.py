...
from ..corp_creditoPersonas.models import AutorizacionCredito
from .models import FacturasEncabezados, FacturasDetalles
from .serializers import FacturasSerializer, FacturasDetallesSerializer, \
    FacturasListarSerializer, FacturaSerializer, FacturasListarTablaSerializer
